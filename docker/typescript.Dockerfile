...
# Copy the files from cortex-exercises (now relative to parent directory)
COPY cortex-exercises/exercises/typescript/package.json ./
COPY cortex-exercises/exercises/typescript/pnpm-lock.yaml ./
COPY cortex-exercises/exercises/typescript/tsconfig.json ./
COPY cortex-exercises/exercises/typescript/vitest.config.ts ./
