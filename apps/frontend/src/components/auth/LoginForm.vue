...
<template>
  <Card class="w-full p-[29px] gap-[15px] rounded-[14.5px] card-login-form flex flex-col flex-grow">
    <CardHeader class="self-stretch flex-col items-center justify-start flex p-0">
      <CardTitle class="grow shrink basis-0 text-[28.88px] font-semibold text-[#181b32] text-center">
        Sign In
      </CardTitle>
      <CardDescription class="grow shrink basis-0 inline-flex text-[16.85px] text-[#5e4a6e] text-center">
    ...
    <CardContent class="self-stretch flex-col items-start justify-start flex gap-[19.26px] p-0">
      ...
      <div class="self-stretch justify-start items-center inline-flex">
        <Separator class="grow shrink basis-0 h-[1.20px] border-[#381653]"></Separator>
        <div class="px-[9.63px] flex-col justify-start items-start gap-3 inline-flex">
          <div class="self-stretch justify-center items-center gap-3 inline-flex">
            <div class="text-[#5e4a6e] text-sm font-normal font-['Axiforma']">OR CONTINUE WITH</div>
          </div>
        </div>
        <Separator class="grow shrink basis-0 h-[1.20px] border-[#381653]"></Separator>
      </div>
      ...
      <form class="self-stretch flex-col gap-[19.26px] inline-flex text-foreground" @submit.prevent="onSubmit">
        <FormField v-slot="{ componentField }" name="username">
          <FormItem>
            <FormLabel class="text-[#181B32] font-medium text-[16.85px] font-['Axiforma']" >Username</FormLabel>
        ...
        <FormField v-slot="{ componentField }" name="password">
          <FormItem>
            <FormLabel class="text-[#181B32] font-medium text-[16.85px] font-['Axiforma']">Password</FormLabel>
            <FormControl class="bg-[#FFFFFF] border-[#E4E4E7]">
        ...
        <Button type="submit" class="w-full bg-[#381653] hover:bg-[#55277a] text-white text-[16.85px] mt-[10px]" :disabled="props.loading">
    ...
    <CardFooter class="flex justify-center items-center w-full p-0">
      <a href="#" class="self-stretch text-[#5e4a6e] text-[16.85px] font-medium">
          Forgot password?
        </a>
    </CardFooter>
  </Card>
