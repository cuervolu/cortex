...
import { WebCodeExecutionService } from "@cortex/shared/services/web-code-execution.service";
...
<template>
    ...
    <div v-else class="flex flex-col h-screen w-full bg-background">
        <ExerciseHeader :lesson="currentLesson" :exercise-name="currentExercise" :file-name="currentFileName"
        ...
        <ResizablePanelGroup direction="horizontal" class="flex-grow">
            <ResizablePanel :default-size="70" :min-size="30">
                <div class="h-screen">
                    ...
                    <CodeEditor v-if="initialCode" v-model:code="editorCode" :language="currentLanguage"
                        ...
                        :active-theme="editorTheme" class="h-screen rounded-md overflow-hidden p-4" @change="handleCodeChange"
            ...
            <ResizablePanel :default-size="30" :min-size="20">
                <ScrollArea class="flex flex-col h-full">
                    <ExercisePanel v-model:active-tab="currentTab" :tabs="panelTabs" :default-tab="defaultPanelTab"
