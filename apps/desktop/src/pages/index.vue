...
<template>
  <div class="self-stretch grow shrink basis-0 p-[30px] justify-between items-start flex flex-wrap h-full">
    ...
    <div
      ...
      <div class="self-stretch justify-start items-center gap-[18px] inline-flex w-full">
        ...
        <NuxtLink to="/roadmaps" class="w-full">
          <Button
            ...
            <div class="text-white text-lg font-medium leading-[35px]">Explorar Roadmaps</div>
          </Button>
        </NuxtLink>
        <!-- Botón 'Mi Perfil' -->
        <NuxtLink to="/profile" class="w-full">
          <Button variant="outline"
            ...
            <div class="text-foreground text-lg font-medium leading-[35px]">Mi Perfil</div>
          </Button>
        </NuxtLink>
      </div>
      ...
      <NuxtLink to="/roadmaps/create " class="w-full">
        <Button
          class="w-full h-[61px] px-5 py-[13px] bg-primary rounded-[14px] justify-center items-center gap-2.5 flex"
          size="lg">
          <BookOpen class="mr-2 h-5 w-5" />
