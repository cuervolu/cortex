...
<template>
  <div
      class="self-stretch grow shrink basis-0 p-[30px] justify-between items-start flex flex-wrap h-full">
    <!-- Sección izquierda -->
    <div
    ...
    <div
      ...
      <img
          src="https://picsum.photos/800/600" alt="Ilustración de aprendizaje"
